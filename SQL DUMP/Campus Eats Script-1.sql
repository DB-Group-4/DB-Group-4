...
--
-- Table structure dor table `item`
--
...
CREATE TABLE `item` (
    ...
    `item_ordered` varchar(75) DEFAULT NULL,
    `order_id` int(11) NOT NULL,
    `restaurant_id` int(11) NOT NULL,
    `quantity_ordered` int(11),
    `special_instructions` varchar(100),
    PRIMARY KEY(`item_id`),
    UNIQUE KEY `item_index_desc` (`item_id` DESC),
...
INSERT INTO `item` VALUES(1,'PIZZA',1,1,2,'leave at door'),(2,'NUGGETS',2,2,1,'-'),(3,'FRIES',3,3,1,'mask mandate'),(4,'DONUT',4,4,5,'-'),(5,'ICECREAM',5,5,2,'-'),
						(6,'PASTRY',6,6,2,'Add spoons'),(7,'CRISPY-CREME',7,7,1,'-'),(8,'NOODLES',8,8,3,'make it spicy'),(9,'PEPSI',9,9,2,'-'),(10,'LEMONADE',10,10,2,'-'),
                        (11,'CHICKEN OVER RICE',11,11,2,'make one spicy and one non-spicy'),(12,'LAMB OVER RICE',12,12,1,'-'),(13,'TORTILLA',13,13,4,'Pack properly'),(14,'VANILA MILKSHAKE',14,14,2,'-'),
                        (15,'ICE COFFEE',15,15,1,'Sugar packets please!'),(16,'STRAWBERRY MILKSHAKE',16,16,1,'-'),(17,'OREOSHAKE',17,17,2,'-'),(18,'BURGER',18,18,8,'add sauce packets'),
                        (19,'RICEBOWL',19,19,1,'-'),(20,'COOKIE',20,20,2,'-');
...
CREATE TABLE `ratings` (
    ...
    `person_id` int(11) NOT NULL,
    `restaurant_rating(1-5)` int(11) NOT NULL,
    `driver_rating(1-5)` int(11) NOT NULL,
    `comment` varchar(100) DEFAULT NULL,
    PRIMARY KEY(`rating_id`),
    UNIQUE KEY `rating_index_desc` (`rating_id` DESC),
...
INSERT INTO `ratings` VALUES(1,1,5,4,'-'),(2,2,3,3,'missing food'),(3,3,5,5,'Great food'),
							(4,4,3,2,'not properly packed'),(5,5,5,5,'-'),(6,6,4,5,'-'),
                            (7,7,5,3,'Driver late'),(8,8,3,4,'Missing Sauce'),(9,9,5,4,'-'),
                            (10,10,5,5,'-'),(11,11,1,1,'Very Bad customer service'),(12,12,5,4,'-'),
                            (13,13,4,4,'-'),(14,14,5,5,'Fast delivery'),(15,15,3,4,'Late Delivery'),
                            (16,16,5,5,'-'),(17,17,4,3,'-'),(18,18,5,5,'nice!'),(19,19,4,4,'-'),(20,20,5,5,'-');
